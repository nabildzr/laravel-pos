...
@section('content')
        ...
        <div class="col-span-12">
            <div class="card border-0 overflow-hidden">
                <div class="card-header">
                    <h6 class="card-title mb-0 text-lg">Reservation Datatables</h6>
                </div>
                        ...
                        <tbody>
                            @foreach ($reservations as $reservation)
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-base mb-0 font-bold grow">{{ $reservation->date }}</h6>
                                    </td>

                                    <td>
                                        <h6 class="text-base mb-0 font-medium grow">
                                            {{ $reservation->category }}</h6>
                                    </td>
                                    <td>
                                        <div class="items-center w-48">
                                            <p class="text-base mb-0 font-medium grow">{{ $reservation->amount }}</p>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="items-center w-48">
                                            <textarea class="text-base mb-0 font-medium grow dark:bg-neutral-600 rounded-xl">{{ $reservation->description }}</textarea>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex items-center">
                                            @if ($reservation->proof)
                                                <img src="{{ asset('storage/' . $reservation->proof) }}" alt=""
                                    ...
                                    <td>
                                        <div class="items-center w-48">
                                            <p class="text-base mb-0 font-medium grow">{{ $reservation->user->name }}</p>
                                        </div>
                                    ...
                                    <td>
                                        <div class="items-center w-48">
                                            <p class="text-base mb-0 font-medium grow">{{ $reservation->created_at }}</p>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="items-center w-48">
                                            <p class="text-base mb-0 font-medium grow">{{ $reservation->updated_at }}</p>
                                        </div>
                                    </td>
                                    <td class="">
    ...
    @foreach ($reservations as $expense)
