        ...
        <div class="col-span-12">
            <div class="card border-0 overflow-hidden">
                <div class="card-header">
                    <h6 class="card-title mb-0 text-lg">Expense Categories Datatables</h6>
                </div>
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('newExpenseCategory') }}"
                        ...
                        <tbody>
                            @foreach ($expenseCategories as $category)
                                <tr>
                                    ...
                                    <td class="">
                                        <a href="{{ url("/expense-categories/edit/$category->id") }}"
                                ...
                                <x-confirm-delete-modal :modalId="'delete-modal-' . $category->id" :route="route('actionDeleteExpenseCategory', $category->id)" />
