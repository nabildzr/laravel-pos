                    ...
                    <div class="mt-4">
                        <ul>
                            <li class="item-active mb-1.5">
                                <a href="{{ url('/') }}" class="hover:bg-primary-50 dark:hover:bg-primary-800/25 group hover:text-neutral-900 px-2.5 py-2.5 w-full rounded-lg text-neutral-600 flex items-center">
