        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-dark-2">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <form id="taskForm">
                    ...
                    <div class="mb-3">
                        <label for="taskTitle"
                            class="inline-block font-semibold text-neutral-600 dark:text-neutral-200 text-sm mb-2">Title</label>
                        <input type="text" class="form-control" placeholder="Enter Event Title " id="taskTitle"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="taskTag"
                            class="inline-block font-semibold text-neutral-600 dark:text-neutral-200 text-sm mb-2">Tag</label>
                    ...
                    <div class="mb-3">
                        <label for="taskImage"
                            class="inline-block font-semibold text-neutral-600 dark:text-neutral-200 text-sm mb-2">Attachments
                            <span class="text-sm">(Jpg, Png format)</span> </label>
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            id="taskImage" type="file">
                        <img id="taskImagePreview" src="{{ asset('assets/images/carousel/carousel-img1.png') }}"
                            alt="Image Preview">
                    </div>
                </form>
            </div>
            <div class="flex items-center gap-4 p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button type="button" data-modal-hide="default-modal"
                    class="border border-danger-600 bg-hover-danger-200 text-danger-600 text-base px-[50px] py-[11px] rounded-lg"
                    data-bs-dismiss="modal">
                    Cancel
                </button>
                <button type="submit" class="btn btn-primary border border-primary-600 text-base px-7 py-3 rounded-lg"
                    id="saveTaskButton">
                    Save Changes
                </button>
            </div>
...
{{-- trigger: --}}
<button type="button" class="card-edit-button text-success-600" data-modal-target="default-modal"
